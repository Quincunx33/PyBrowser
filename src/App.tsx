...
import { 
  ...
  Folder, Plus, Trash2, Upload, FileCode, FolderPlus, Edit2,
                ...
                {sideView === 'files' ? (
                  <>
                    <div className="flex items-center justify-between mb-6">
                      ...
                      <div className="flex items-center gap-2">
                        <button onClick={() => { setCreatingType('file'); setNewName(''); }} title="New File" className="p-1 hover:text-emerald-500 transition-colors"><Plus className="w-4 h-4" /></button>
                        <button onClick={() => { setCreatingType('folder'); setNewName(''); }} title="New Folder" className="p-1 hover:text-emerald-500 transition-colors"><FolderPlus className="w-4 h-4" /></button>
